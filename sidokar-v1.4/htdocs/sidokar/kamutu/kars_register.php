...
if(isset($_GET['token']))
{
    $sql1 = "SELECT user_id FROM applicant_user WHERE md5(CONCAT('D!yurm@nG3@',user_email)) = '".$_GET['token']."' AND user_record_status = 'P'";
    $user_id = get_data($sql1,"user_id");
    
    if($user_id != "")
    {
        $sql2 = "UPDATE applicant_user SET user_record_status = 'A' WHERE user_id IN('$user_id')";
...
<body class="skin-default card-no-border" style="background-image:url(./images/background/background2.jpg); background-repeat: no-repeat; height: 100%; background-position: center;background-repeat: no-repeat;background-size: cover;">
    <!-- ============================================================== -->
                    ...
                    <form class="form-horizontal form-material" id="loginform" method="post">
                        <div class="form-group">
                            <div class="col-xs-12 text-center">
                                <div class="user-thumb text-center"> <img alt="thumbnail" class="img-circle" width="80" src="./images/key.png">
                                    <h3><?php echo "CALON SURVEIOR" ?></h3> </div>
                            </div>
                        </div>
                        <div class="form-group ">
                            <div class="col-xs-12">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                <a href="./application/registration/applicant_registration.php" class="text-info m-l-5"><b>Form Registrasi Calon Surveior</b></a>
                            </div>
                        </div>
                    </form>
    ...
    $(document).ready(function() {
        $("#loginform").submit(function() {
            ...
            $.ajax({
    			...
    			success: function(data) {	
                    ...
                    $('#results').html(data);
                    if (data === "") {
                        window.location='./application/dashboard/dashboard_applicant.php'
                    }
    			},
        ...
        $("#recoverform").submit(function() {
            ...
            $.ajax({
    			type: "POST",
    			url: 'register_password_recovery.php',
    			data: recoveryJSON,
                dataType: 'json',
    			success: function (data) {	
    				// Inserting html into the result div
